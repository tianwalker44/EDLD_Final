...
dat2_long %>% 
  ...
  ggplot(aes(mean_hs, crp)) + geom_point(aes(color = levels_dbts)) + geom_smooth(aes(color = levels_dbts), method = "lm") + scale_color_brewer(type = "div", palette = 4) + labs(caption = "Mean health score is calculated such that higher scores = worse health") + theme_apa()
