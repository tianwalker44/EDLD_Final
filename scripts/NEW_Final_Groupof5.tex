...
Demo of inline code usage. We found that this regression model using 357 participants was not significant \(F\)(2, 354) = 1.06, \(p\) = 0.35 with \(R^2\) = 0.01. The beta estimate for age was \(\beta_{age}\) = -0.01 (\(SE\) = 0.01, \(p\) = 0.36), and for use of medication \(\beta_{medication}\) = 0.20 (\(SE\) = 0.18, \(p\) = 0.28).
...
Demo of inline code usage. We found that this regression model using 354 participants was not significant \(F\)(2, 354) = 2.70, \(p\) = 0.07 with \(R^2\) = 0.01. The beta estimate for age was \(\beta_{age}\) = -0.01 (\(SE\) = 0.01, \(p\) = 0.41), and for diet and exercise \(\beta_{Diet}\) = -0.24 (\(SE\) = 0.12, \(p\) \textless{} 0.05).
