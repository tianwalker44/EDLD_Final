...
\hypersetup{
  pdftitle={Relations between Inflammation and Access to care, Treatment, and Diabetes in Older Mexico},
...
\begin{figure}[H]
<<<<<<< HEAD
\includegraphics{NEW_Final_Groupof5_files/figure-latex/unnamed-chunk-3-1} \caption{ }\label{fig:unnamed-chunk-3}
\end{figure}

\begin{figure}[H]
\includegraphics{NEW_Final_Groupof5_files/figure-latex/unnamed-chunk-4-1} \caption{ }\label{fig:unnamed-chunk-4}
=======
...
##     is_empty: function
##     labels: Diet & Exercise Medication
##     limits: NULL
...
\begin{figure}[H]
<<<<<<< HEAD
\includegraphics{NEW_Final_Groupof5_files/figure-latex/unnamed-chunk-5-1} \caption{ }\label{fig:unnamed-chunk-5}
=======
...
=======
\# Results
>>>>>>> d68fbfed796ae31a1d591c9f05853138bdea0006
