...
\title{Relations between Inflammation, access to care and Diabetes in a repesentative population of Mexico.}
...
\begin{figure}
\centering
\includegraphics{NEW_Final_Groupof5_files/figure-latex/data-cleaning-tian2-1.pdf}
\caption{\label{fig:data-cleaning-tian2}Figure \ref{fig:data-cleaning-tian2} caption goes here.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{NEW_Final_Groupof5_files/figure-latex/fig1-1.pdf}
\caption{\label{fig:fig1}This is the caption of figure \ref{fig:fig1}.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{NEW_Final_Groupof5_files/figure-latex/fig2-1.pdf}
\caption{\label{fig:fig2}This is the caption of figure 2.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{NEW_Final_Groupof5_files/figure-latex/fig3-1.pdf}
\caption{\label{fig:fig3}This is the caption of figure \ref{fig:fig3}.}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-1}Effect of Medication on CRP, controlling for Age. }
...
Demo of inline code usage. We found that this regression model using 357 participants was not significant \(F\)(2, 354) = 1.06, \(p\) = 0.35 with \(R^2\) = 0.01. The regression coefficient for age was \(b_{age}\) = -0.01 (\(SE\) = 0.01, \(p\) = 0.36), and for use of medication \(b_{medication}\) = 0.20 (\(SE\) = 0.18, \(p\) = 0.28).
...
Demo of inline code usage. We found that this regression model using 354 participants was not significant \(F\)(2, 354) = 2.70, \(p\) = 0.07 with \(R^2\) = 0.01. The regression coefficient for age was \(b_{age}\) = -0.01 (\(SE\) = 0.01, \(p\) = 0.41), and for diet and exercise \(b_{Diet}\) = -0.24 (\(SE\) = 0.12, \(p\) \textless{} 0.05).

\begin{figure}
\centering
\includegraphics{NEW_Final_Groupof5_files/figure-latex/tableofcrpmedicationandexercise-1.pdf}
\caption{\label{fig:tableofcrpmedicationandexercise}Caption for Figure \ref{fig:tableofcrpmedicationandexercise} goes here.}
\end{figure}
