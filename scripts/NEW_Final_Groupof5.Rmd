...
(plot_all <- dat %>% 
  ...
  labs(title = "CRP and HbA1c by Medication for Diagnosis", x = "HbA1c", y = "CRP")+
...
(plot_all2 <- dat %>% 
  ...
  theme_apa() + 
  labs(title = "Inflammation and HbA1c by Diabetes Treatment", caption = "dark green points should not be there",
       x = "HbA1c",
       y = "Inflammation (CRP)"))
...
(tian_hba1c_65 <- plot.a + 
  ...
  labs( title = "CRP and HbA1c by Diabetes Treatment", 
