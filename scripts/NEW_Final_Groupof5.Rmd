...
#Ths above code filter isn't filtering the "and" with each line of data but first filtering all of those that don't equal no treatment and then filering out everyone with an hba1c below 6.5...which is not what we want 

#So I made a new variable that we an use to filter:
data <- data %>% 
