...
#Area of Improvement 1: This chunk would not run for me. It could be a quirk with my setup in R studio, but I suggest having multiple group members confirm that this runs for them to ensure it will work for Joe. -Megan
mex_survey <- import('mexico_raw_dat.sav')
...
#Area of Strength 1: Your code is very well documented and easy to follow. Great job making it readable and easy on reviewers :) - Megan
...
#Area of Strength 2: I like your approach of building a linear model using this data. Even though the results aren't significant, it was a really interesting idea! - Megan

#Something I learned: I have been filtering things piecemeal, and I didn't know that you could use and/or operators to filter things all at once like you do below. So cool! - Megan
RQ1_df <- data %>% 
...
```{r}
#Area of Strength 3: This graph is really aesthetically nice, and it does a good job of showing the results of your model. 
RQ1_df %>% 
