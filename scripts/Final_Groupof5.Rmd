...
#Regression 1: only diabetes population: hba1c regressed onto CRP among those doing an intervention or not

data$medication <- as.factor(data$medication )
mreg1 <- lm(crp~hba1c + as.factor(medication), data = mexico)
...
creg1 <- lm(crp~hba1c + as.factor(medication), data = china)
